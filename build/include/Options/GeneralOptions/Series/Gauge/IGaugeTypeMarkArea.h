...
#include "Options/GeneralOptions/Series/Gauge/IGaugeTypeMarkAreaData.h"
...
namespace IIChart
{
	namespace Gauge
	{
		/*@class
		*************************************************************************
		* 类  名: IGaugeTypeMarkArea
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 图表标域。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IGaugeTypeMarkArea
		{
		public:
			...
			******************************************************************
			功  能：创建标域的数据对象
			参  数：<无>;
			返回值：<IGaugeTypeMarkAreaData*>;
			 ------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IGaugeTypeMarkAreaData* CreateData() = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int AddData(IGaugeTypeMarkAreaData* pData0, IGaugeTypeMarkAreaData* pData1) = 0;
