#pragma once
/***********************************************************************
 * Module:  IGaugeTypeMarkAreaLabel.h
 * Author:  杨鹏辉
 * Modified: 2022年7月1日 15:02:44
 * Purpose: 标域文本配置，可用于说明图形的一些数据信息，比如值，名称等。
 ***********************************************************************/
...
namespace IIChart
{
	namespace Gauge
	{
		/*@class
		*************************************************************************
		* 类  名: IGaugeTypeMarkAreaLabel
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 标域文本配置。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IGaugeTypeMarkAreaLabel
		{
		public:
			...
			******************************************************************/
			...
			virtual void GetPosition(int* pnX, int* pnY, bool* bIsPercentage) = 0;
