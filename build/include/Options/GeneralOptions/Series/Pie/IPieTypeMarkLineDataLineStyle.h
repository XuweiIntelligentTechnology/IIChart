 ...
 * Purpose: 标线数据项的线条样式，起点和终点项的 lineStyle会合并到一起。
 ***********************************************************************/
...
namespace IIChart
{
	namespace Pie
	{
		/*@class
		*************************************************************************
		* 类  名: IPieTypeMarkLineDataLineStyle
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 标线数据项的线条样式。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IPieTypeMarkLineDataLineStyle
		{
		public:
			/*@function
			******************************************************************
