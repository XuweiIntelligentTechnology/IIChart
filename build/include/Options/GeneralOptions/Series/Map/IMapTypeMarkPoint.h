...
#include "Options/GeneralOptions/Series/Map/IMapTypeMarkPointData.h"
...
namespace IIChart
{
	namespace Map
	{
		/*@class
		*************************************************************************
		* 类  名: IMapTypeMarkPoint
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 图表标注
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IMapTypeMarkPoint
		{
		public:
			...
			******************************************************************
			 ...
			 参  数：<无>;
			 返回值：<IMapTypeMarkPointData*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IMapTypeMarkPointData* CreateData() = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int Add(IMapTypeMarkPointData* pData) = 0;
