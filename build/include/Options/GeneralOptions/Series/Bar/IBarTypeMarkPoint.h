...
#include "Options/GeneralOptions/Series/Bar/IBarTypeMarkPointBlur.h"
#include "Options/GeneralOptions/Series/Bar/IBarTypeMarkPointEmphasis.h"
#include "Options/GeneralOptions/Series/Bar/IBarTypeMarkPointData.h"
...
namespace IIChart
{
	namespace Bar
	{
		/*@class
		*************************************************************************
		* 类  名: IBarTypeMarkPoint
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 图表标注。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IBarTypeMarkPoint
		{
		public:
			...
			******************************************************************
			 功  能：标注的高亮样式。
			 参  数：<无>;
			 返回值：<IBarTypeMarkPointEmphasis*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IBarTypeMarkPointEmphasis* GetEmphasis() = 0;

			/*@function
			******************************************************************
			 功  能：标注的淡出样式。淡出的规则跟随所在系列。
			 参  数：<无>;
			 返回值：<IBarTypeMarkPointBlur*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IBarTypeMarkPointBlur* GetBlur() = 0;
			...
			******************************************************************
			 ...
			 参  数：<无>;
			 返回值：<IBarTypeMarkPointData*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IBarTypeMarkPointData* CreateData() = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int AddData(IBarTypeMarkPointData* pData) = 0;
