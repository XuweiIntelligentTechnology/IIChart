...
#include "Options/GeneralOptions/Series/Bar/IBarTypeMarkAreaBlur.h"
#include "Options/GeneralOptions/Series/Bar/IBarTypeMarkAreaEmphasis.h"
...
namespace IIChart
{
	namespace Bar
	{
		...
		/*@class
		*************************************************************************
		* 类  名: IBarTypeMarkAreaData
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 图表标域数据
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IBarTypeMarkAreaData : virtual public IBaseArrayElement
		{
		public:
			...
			******************************************************************
			功  能：该数据项的高亮样式和标签设置
			参  数：<无>;
			返回值：<IBarTypeMarkAreaEmphasis*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IBarTypeMarkAreaEmphasis* GetEmphasis() = 0;

			/*@function
			******************************************************************
			功  能：该数据项的淡出样式和标签设置
			参  数：<无>;
			返回值：<IBarTypeMarkAreaBlur*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IBarTypeMarkAreaBlur* GetBlur() = 0;
		};
	}
}