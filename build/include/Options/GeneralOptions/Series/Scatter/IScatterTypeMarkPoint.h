#pragma once
/***********************************************************************
 * Module:  IScatterTypeMarkPoint.h
 * Author:  杨鹏辉
...
#include "Options/GeneralOptions/Series/Scatter/IScatterTypeMarkPointLabel.h"
#include "Options/GeneralOptions/Series/Scatter/IScatterTypeMarkPointItemStyle.h"
#include "Options/GeneralOptions/Series/Scatter/IScatterTypeMarkPointBlur.h"
#include "Options/GeneralOptions/Series/Scatter/IScatterTypeMarkPointEmphasis.h"
#include "Options/GeneralOptions/Series/Scatter/IScatterTypeMarkPointData.h"
...
namespace IIChart
{
	namespace Scatter
	{
		/*@class
		*************************************************************************
		* 类  名: IScatterTypeMarkPoint
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 图表标注。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IScatterTypeMarkPoint
		{
		public:
			...
			******************************************************************
			 功  能：标注的文本。
			 参  数：<无>;
			 返回值：<IScatterTypeMarkPointLabel*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IScatterTypeMarkPointLabel* GetLabel() = 0;

			/*@function
			******************************************************************
			 功  能：标注的图形样式。
			 参  数：<无>;
			 返回值：<IScatterTypeMarkPointItemStyle*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IScatterTypeMarkPointItemStyle* GetItemStyle() = 0;

			/*@function
			******************************************************************
			 功  能：标注的高亮样式。
			 参  数：<无>;
			 返回值：<IScatterTypeMarkPointEmphasis*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IScatterTypeMarkPointEmphasis* GetEmphasis() = 0;

			/*@function
			******************************************************************
			 功  能：标注的淡出样式。淡出的规则跟随所在系列。
			 参  数：<无>;
			 返回值：<IScatterTypeMarkPointBlur*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IScatterTypeMarkPointBlur* GetBlur() = 0;
			...
			******************************************************************/
			...
			/*@function
			******************************************************************
			 功  能：创建一个标注数据对象，使用完一定要调用Release()
			 参  数：<无>;
			 返回值：<IScatterTypeMarkPointData*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IScatterTypeMarkPointData* CreateData() = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int AddData(IScatterTypeMarkPointData* pData) = 0;
