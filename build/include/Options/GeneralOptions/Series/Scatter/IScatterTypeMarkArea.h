...
#include "Options/GeneralOptions/Series/Scatter/IScatterTypeMarkAreaLabel.h"
#include "Options/GeneralOptions/Series/Scatter/IScatterTypeMarkAreaItemStyle.h"
#include "Options/GeneralOptions/Series/Scatter/IScatterTypeMarkAreaBlur.h"
#include "Options/GeneralOptions/Series/Scatter/IScatterTypeMarkAreaEmphasis.h"
#include "Options/GeneralOptions/Series/Scatter/IScatterTypeMarkAreaData.h"
...
namespace IIChart
{
	namespace Scatter
	{
		/*@class
		*************************************************************************
		* 类  名: IScatterTypeMarkArea
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 图表标域，常用于标记图表中某个范围的数据，例如标出某段时间投放了广告。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IScatterTypeMarkArea
		{
		public:
			...
			******************************************************************
			功  能：标域文本配置。
			参  数：<无>;
			返回值：<IScatterTypeMarkAreaLabel*>;
			 ------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IScatterTypeMarkAreaLabel* GetLabel() = 0;

			/*@function
			******************************************************************
			功  能：该标域的样式。
			参  数：<无>;
			返回值：<IScatterTypeMarkAreaItemStyle*>;
			 ------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IScatterTypeMarkAreaItemStyle* GetItemStyle() = 0;

			/*@function
			******************************************************************
			功  能：高亮的标域样式。
			参  数：<无>;
			返回值：<IScatterTypeMarkAreaEmphasis*>;
			 ------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IScatterTypeMarkAreaEmphasis* GetEmphasis() = 0;

			/*@function
			******************************************************************
			功  能：淡出的标域样式。淡出的规则跟随所在系列。
			参  数：<无>;
			返回值：<IScatterTypeMarkAreaBlur*>;
			 ------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IScatterTypeMarkAreaBlur* GetBlur() = 0;
			...
			******************************************************************
			功  能：创建标域的数据对象
			参  数：<无>;
			返回值：<IScatterTypeMarkAreaData*>;
			 ------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IScatterTypeMarkAreaData* CreateData() = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int AddData(IScatterTypeMarkAreaData* pData0, IScatterTypeMarkAreaData* pData1) = 0;
