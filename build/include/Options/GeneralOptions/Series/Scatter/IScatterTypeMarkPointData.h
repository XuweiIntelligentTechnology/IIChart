#pragma once
/***********************************************************************
 * Module:  IScatterTypeMarkPointData.h
 * Author:  杨鹏辉
...
#include "Options/GeneralOptions/Series/Scatter/IScatterTypeMarkPointDataLabel.h"
#include "Options/GeneralOptions/Series/Scatter/IScatterTypeMarkPointDataItemStyle.h"
#include "Options/GeneralOptions/Series/Scatter/IScatterTypeMarkPointDataEmphasis.h"
...
namespace IIChart
{
	namespace Scatter
	{
		/*@class
		*************************************************************************
		* 类  名: IScatterTypeMarkPointData
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 标注的数据对象
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IScatterTypeMarkPointData : virtual public IBaseArrayElement
		{
		public:
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual void SetType(EMarkPointDataType eValue) = 0;
			virtual EMarkPointDataType GetType() const = 0;
			...
			******************************************************************
			功  能：该标注的标签样式
			参  数：<nValue>;
			返回值：<IScatterTypeMarkPointDataLabel*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IScatterTypeMarkPointDataLabel* GetLabel() = 0;

			/*@function
			******************************************************************
			功  能：该标注的图形样式
			参  数：<nValue>;
			返回值：<IScatterTypeMarkPointDataItemStyle*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IScatterTypeMarkPointDataItemStyle* GetItemStyle() = 0;

			/*@function
			******************************************************************
			功  能：该标注的高亮样式
			参  数：<nValue>;
			返回值：<IScatterTypeMarkPointDataEmphasis*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IScatterTypeMarkPointDataEmphasis* GetEmphasis() = 0;
