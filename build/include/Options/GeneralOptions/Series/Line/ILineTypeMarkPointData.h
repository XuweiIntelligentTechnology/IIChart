...
#include "Options/GeneralOptions/Series/Line/ILineTypeMarkPointDataItemStyle.h"
#include "Options/GeneralOptions/Series/Line/ILineTypeMarkPointDataEmphasis.h"
...
namespace IIChart
{
	namespace Line
	{
		/*@class
		*************************************************************************
		* 类  名: ILineTypeMarkPointData
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 标注的数据
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class ILineTypeMarkPointData : virtual public IBaseArrayElement
		{
		public:
			...
			******************************************************************
			功  能：该标注的样式。
			参  数：<无>;
			返回值：<ILineTypeMarkPointDataItemStyle*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual ILineTypeMarkPointDataItemStyle* GetItemStyle() = 0;

			/*@function
			******************************************************************
			功  能：该标注的高亮样式。
			参  数：<无>;
			返回值：<ILineTypeMarkPointDataEmphasis*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual ILineTypeMarkPointDataEmphasis* GetEmphasis() = 0;
