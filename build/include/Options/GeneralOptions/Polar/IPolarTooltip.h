#pragma once
/***********************************************************************
 * Module:  IPolarTooltip.h
 * Author:  杨鹏辉
 * Modified: 2022年7月1日 15:02:44
 * Purpose: 本坐标系特定的 tooltip 设定。
 *          提示框组件的通用介绍：
 * 
 *          提示框组件可以设置在多种地方：
 *          * 可以设置在全局，即 tooltip
...
#include "Options/GeneralOptions/Polar/IPolarTooltipAxisPointer.h"
#include "Options/GeneralOptions/Polar/IPolarTooltipTextStyle.h"
	...
	namespace Polar
	{
		...
		public:
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IPolarTooltipAxisPointer* GetAxisPointer() = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int SetPositionJSFun(const wchar_t* wzValue) = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int SetValueFormatterJSFun(const wchar_t* wzValue) = 0;

			/*@function
			******************************************************************
			功  能：设置文字块背景色;如果设置为 'inherit'，则为视觉映射得到的颜色，如系列色。
			注  意：为颜色值时，可以使用以下形式，
			...
			******************************************************************
			功  能：提示框浮层的文本样式;
			参  数：<无>;
			返回值：<IPolarTooltipTextStyle*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IPolarTooltipTextStyle* GetTextStyle() = 0;
