...
#include "Options/GeneralOptions/Polar/IPolarTooltipAxisPointerLabel.h"
#include "Options/GeneralOptions/Polar/IPolarTooltipAxisPointerLineStyle.h"
#include "Options/GeneralOptions/Polar/IPolarTooltipAxisPointerCrossStyle.h"
...
namespace IIChart
{
	namespace Polar
	{
		...
		************************************************************************/
		class IPolarTooltipAxisPointer
		{
		public:
			/*@function
			******************************************************************
			...
			******************************************************************
			功  能：获取坐标轴指示器的文本标签;
			参  数：<无>;
			返回值：<IPolarTooltipAxisPointerLabel*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IPolarTooltipAxisPointerLabel* GetLabel() = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IPolarTooltipAxisPointerLineStyle* GetLineStyle() = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IPolarTooltipAxisPointerCrossStyle* GetCrossStyle() = 0;
