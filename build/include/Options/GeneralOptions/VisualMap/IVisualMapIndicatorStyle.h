...
namespace IIChart
{
	namespace VisualMap
	{
		/*@class
		***********************************************************************
		* 类  名: IVisualMapHandleStyle
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 指示器样式。
		-----------------------------------------------------------------------
		* 作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IVisualMapIndicatorStyle // Format 未定义
		{
		public:
			...
			******************************************************************/
			...
			/*@function
			*****************************************************************
			 功  能：用于设置每两条虚线段之间的偏移量，可搭配 borderType 指
			...
			*****************************************************************
			 功  能：用于设置斜接面限制比例。
			 注  意：只有当 borderJoin 为 miter 时， borderMiterLimit 才有效。
			 参  数：<nValue>  默认值为 10。负数、0、Infinity 和 NaN 均会被忽略;
			 返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			...
			******************************************************************/
			...
			/*@function
			******************************************************************
			功  能：阴影颜色,此方式除可设置纯色外还可以设置为渐变色和纹理填充;
			参  数：<略>;
			返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			...
			******************************************************************
			功  能：图形透明度;
			参  数：<fValue> 支持从 0 到 1 的数字，为 0 时不绘制该图形;
			返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
