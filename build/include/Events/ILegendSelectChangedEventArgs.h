#pragma once
/***********************************************************************
 * Module:  ILegendSelectChangedEventArgs.h
 * Author:  杨鹏辉
...
namespace IIChart
{
	...
	class ILegendSelectChangedEventArgs : virtual public IEventArgs
	{
	public:
		...
		virtual int GetSelected(int nIndex, wchar_t* wzName, bool* pbValue) = 0;
