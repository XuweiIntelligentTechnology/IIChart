/***********************************************************************
 * Module:  ILegendToggleSelectActionArgs.h
 * Author:  杨鹏辉
 * Modified: 2022年6月30日 11:42:37
 * Purpose: Declaration of the class ILegendToggleSelectActionArgs
 ***********************************************************************/
#pragma once
...
namespace IIChart
{
	...
	class ILegendToggleSelectAction : virtual public IAction
	{
	public:
