...
namespace IIChart
{
	namespace TimeLine
	{
		...
		class ITimeLineLabel // Format 未定义
		{
		public:
			
			virtual void SetPosition(int nValue) = 0;
			virtual void GetPosition(int* pnValue) const = 0;

			virtual void SetPosition(ETimeLinePosition eValue) = 0;
			virtual ETimeLinePosition GetPosition() const = 0;
