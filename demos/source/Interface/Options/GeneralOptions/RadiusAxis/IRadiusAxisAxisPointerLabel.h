#pragma once
/***********************************************************************
 * Module:  IRadiusAxisAxisPointerLabel.h
 * Author:  杨鹏辉
...
namespace IIChart
{
	namespace RadiusAxis
	{
		/*@class
		*************************************************************************
		* 类  名: IRadiusAxisAxisPointerLabel
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 坐标轴刻度标签的相关设置。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IRadiusAxisAxisPointerLabel
		{
		public:
			/*@function
			******************************************************************
			功  能：是否显示刻度标签。如果 tooltip.axisPointer.type 设置为 'cross' 则默认显示标签，否则默认不显示。
			参  数：<bShow>;
			返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			...
			/*@function
			******************************************************************
			功  能：文本标签中数值的小数点精度。默认根据当前轴的值自动判断。
				   也可以指定如 2 表示保留两位小数。
			参  数：<nValue>;
			返回值：<无>;
			------------------------------------------------------------------
			...
			******************************************************************
			...
			参  考：https://echarts.apache.org/zh/option.html#xAxis.axisPointer.status
			参  数：<wzValue> 为 nullptr 或 L"" 时为不指定;可以是例如：
