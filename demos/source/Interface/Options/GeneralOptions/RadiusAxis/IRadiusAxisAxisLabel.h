...
namespace IIChart
{
	namespace RadiusAxis
	{
		/*@class
		*************************************************************************
		* 类  名: IRadiusAxisAxisLabel
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 坐标轴刻度标签的相关设置。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IRadiusAxisAxisLabel
		{
		public:
			/*@function
			******************************************************************
			...
			******************************************************************
			...
			参  考：https://echarts.apache.org/zh/option.html#xAxis.axisLabel
			...
			******************************************************************
			...
			注  意：回调函数格式：
				...
				更详细说明，可参考：https://echarts.apache.org/zh/option.html#xAxis.axisLabel
			参  数：<wzValue> 字符串模板;
			返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			...
			/*@function
			******************************************************************
			功  能：是否显示最小 tick 的 label。
			注  意：默认自动判定（即如果标签重叠，不会显示最小 tick 的 label）。
			参  数：<bShow> ;
			返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual void SetShowMinLabel(bool bShow) = 0;
			virtual bool GetShowMinLabel() const = 0;

			/*@function
			******************************************************************
			功  能：是否显示最大 tick 的 label。
			注  意：默认自动判定（即如果标签重叠，不会显示最小 tick 的 label）。
			参  数：<bShow> ;
			返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual void SetShowMaxLabel(bool bShow) = 0;
			virtual bool GetShowMaxLabel() const = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual void SetHideOverlap(bool bShow) = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int SetColorJSFun(const wchar_t* wzJSFun) = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int SetColorCallback(ColorCallback* pCallback) = 0;
