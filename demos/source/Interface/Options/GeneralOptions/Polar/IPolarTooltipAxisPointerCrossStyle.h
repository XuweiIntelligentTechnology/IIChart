#pragma once
/***********************************************************************
 * Module:  IPolarToolTipAxisPointerCrossStyle.h
 * Author:  杨鹏辉
...
namespace IIChart
{
	namespace Polar
	{
		/*@class
		*************************************************************************
		* 类  名: IPolarTooltipAxisPointerCrossStyle
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 本坐标系特定的 tooltip 的坐标轴指示器十字线的样式：
		*          axisPointer.type 为 'cross' 时有效。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IPolarTooltipAxisPointerCrossStyle
		{
		public:
			/*@function
			******************************************************************
