#pragma once
/***********************************************************************
 * Module:   IPieTypeDataItemStyle.h
 * Author:   杨鹏辉
 * Modified: 2022年7月1日 15:02:44
 * Purpose:  单个数据项对应的图形样式。
 ***********************************************************************/
#include "Common/IEnum.h"
#include "Options/Common/IRich.h"
#include "Common/ICallback.h"
#include "Options/GeneralOptions/Series/Pie/IPieTypeDecal.h"
...
namespace IIChart
{
	namespace Pie
	{
		/*@class
		*************************************************************************
		* 类  名: IPieTypeDataItemStyle
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 单个数据项对应的图形样式
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IPieTypeDataItemStyle
		{
		public:
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IPieTypeDecal* GetDecal() = 0;

			/*@function
			******************************************************************
			 功  能：用于指定饼图扇形区块的内外圆角半径
					 左上，右上，左下，右下都用一样的圆角;
