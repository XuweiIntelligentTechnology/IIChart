...
#include "Options/GeneralOptions/Series/Pie/IPieTypeMarkLineDataLineStyle.h"
#include "Options/GeneralOptions/Series/Pie/IPieTypeMarkLineDataLabel.h"
#include "Options/GeneralOptions/Series/Pie/IPieTypeMarkLineDataEmphasis.h"
#include "Options/GeneralOptions/Series/Pie/IPieTypeMarkLineDataBlur.h"
...
namespace IIChart
{
	namespace Pie
	{
		/*@class
		*************************************************************************
		* 类  名: IBarTypeMarkLineData
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 标线的数据
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IPieTypeMarkLineData : virtual public IBaseArrayElement
		{
		public:
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IPieTypeMarkLineDataLineStyle* GetLineStyle() = 0;

			/*@function
			******************************************************************
			功  能：该数据项线的Label
			参  数：<无>;
			返回值：<IPieTypeMarkLineDataLabel*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IPieTypeMarkLineDataLabel* GetLabel() = 0;
			
			/*@function
			******************************************************************
			功  能：该数据项线的高亮样式
			参  数：<无>;
			返回值：<IPieTypeMarkLineDataEmphasis*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IPieTypeMarkLineDataEmphasis* GetEmphasis() = 0;

			/*@function
			******************************************************************
			功  能：该数据项线的淡出样式
			参  数：<无>;
			返回值：<IPieTypeMarkLineDataBlur*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IPieTypeMarkLineDataBlur* GetBlur() = 0;
		};
	}
}