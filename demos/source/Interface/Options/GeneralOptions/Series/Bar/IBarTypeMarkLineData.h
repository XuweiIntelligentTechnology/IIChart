#pragma once
/***********************************************************************
 * Module:  IBarTypeMarkLineData.h
 * Author:  杨鹏辉
 * Modified: 2022年7月1日 15:02:44
 * Purpose: 标域数据数组中的单个数据。
 *     
 ...
 *		3. 直接用 type 属性标注系列中的最大值，最小值。这时候可以使用 valueIndex 或者 valueDim 指定是
 *		   在哪个维度上的最大值、最小值、平均值。
...
namespace IIChart
{
	namespace Bar
	{
		...
		************************************************************************/
		class IBarTypeMarkLineData : virtual public IBaseArrayElement
		{
		public:
