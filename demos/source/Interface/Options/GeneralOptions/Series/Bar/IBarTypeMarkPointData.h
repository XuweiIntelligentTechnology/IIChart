#pragma once
/***********************************************************************
 * Module:  IBarTypeMarkPointData.h
 * Author:  杨鹏辉
...
#include "Options/GeneralOptions/Series/Bar/IBarTypeMarkPointDataLabel.h"
#include "Options/GeneralOptions/Series/Bar/IBarTypeMarkPointItemStyle.h"
#include "Options/GeneralOptions/Series/Bar/IBarTypeMarkPointDataEmphasis.h"
...
namespace IIChart
{
	namespace Bar
	{
		/*@class
		*************************************************************************
		* 类  名: IBarTypeMarkPointData
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 标注的数据
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IBarTypeMarkPointData : virtual public IBaseArrayElement
		{
		public:
			...
			******************************************************************
			功  能：该标注数据的标签
			参  数：<无>;
			返回值：<IBarTypeMarkPointDataLabel*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IBarTypeMarkPointDataLabel* GetLabel() = 0;
			...
			******************************************************************
			功  能：该标注数据的高亮样式。
			参  数：<无>;
			返回值：<IBarTypeMarkPointDataEmphasis*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IBarTypeMarkPointDataEmphasis* GetEmphasis() = 0;
