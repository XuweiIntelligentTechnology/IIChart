#pragma once
/***********************************************************************
 * Module:  ISunburstTypeLabel.h
 * Author:  杨鹏辉
 * Modified: 2022年7月1日 15:02:44
 * Purpose: label 描述了每个扇形块中，标签的样式。
 *          优先级：series.data.label > series.levels.label > series.label。
 *          图形上的标签，可用于说明图形的一些数据信息，比如值，名称等。
 ***********************************************************************/
...
namespace IIChart
{
	namespace Sunburst
	{
		/*@class
		*************************************************************************
		* 类  名: ISunburstTypeLabel
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 图形上的标签，可用于说明图形的一些数据信息，比如值，名称等。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class ISunburstTypeLabel
		{
		public:
			...
			******************************************************************
			功  能：通过内置的语义声明标签的位置。
			参  数：<wzValue> 可以是 L"outside" 等语议;
			返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual void SetPosition(const wchar_t* wzValue) = 0;
			virtual void GetPosition(wchar_t** pwzValue) = 0;
