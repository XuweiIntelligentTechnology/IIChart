#pragma once
/***********************************************************************
 * Module:   ILineTypeSelectAreaStyle.h
 * Author:   杨鹏辉
 * Modified: 2022年7月1日 15:02:44
 * Purpose:  折线图的选中时的区域填充样式
 ***********************************************************************/
...
namespace IIChart
{
	namespace Line
	{
		/*@class
		*************************************************************************
		* 类  名: ILineTypeSelectAreaStyle
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 折线图的选中时的区域填充样式。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class ILineTypeSelectAreaStyle
		{
		public:
			...
			******************************************************************/
			...
			/*@function
			******************************************************************
			功  能：设置折线图的选中时的区域填充样式的阴影颜色，此方式除可设置纯色外还可以设置为渐变色和纹理填充;
			参  数：<pValue>;
			返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			...
			/*@function
			******************************************************************
			功  能：折线图的选中时的区域填充样式阴影的模糊大小;
			注  意：该属性配合 shadowColor,shadowOffsetX, shadowOffsetY 一起设置折线图的选中时的区域填充样式的阴影效果。
			参  数：<略>;
			返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			...
			******************************************************************
			功  能：折线图的选中时的区域填充透明度
			参  数：<nValue> 从 0 到 1 的数字，为 0 时不绘制该折线图的选中时的区域填充样式。;
			返回值：<错误码>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
