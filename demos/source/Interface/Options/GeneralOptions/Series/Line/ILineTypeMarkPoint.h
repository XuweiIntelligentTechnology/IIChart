...
#include "Options/GeneralOptions/Series/Line/ILineTypeMarkPointItemStyle.h"
#include "Options/GeneralOptions/Series/Line/ILineTypeMarkPointBlur.h"
#include "Options/GeneralOptions/Series/Line/ILineTypeMarkPointEmphasis.h"
#include "Options/GeneralOptions/Series/Line/ILineTypeMarkPointData.h"
...
namespace IIChart
{
	namespace Line
	{
		/*@class
		*************************************************************************
		* 类  名: ILineTypeMarkPoint
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 图表标注。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class ILineTypeMarkPoint 
		{
		public:
			...
			******************************************************************
			 功  能：标注的样式。
			 参  数：<无>;
			 返回值：<ILineTypeMarkPointItemStyle*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual ILineTypeMarkPointItemStyle* GetItemStyle() = 0;

			/*@function
			******************************************************************
			 功  能：标注的高亮样式。
			 参  数：<无>;
			 返回值：<ILineTypeMarkPointEmphasis*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual ILineTypeMarkPointEmphasis* GetEmphasis() = 0;

			/*@function
			******************************************************************
			 功  能：标注的淡出样式。淡出的规则跟随所在系列。
			 参  数：<无>;
			 返回值：<ILineTypeMarkPointBlur*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual ILineTypeMarkPointBlur* GetBlur() = 0;
			...
			******************************************************************
			 ...
			 参  数：<无>;
			 返回值：<ILineTypeMarkPointData*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual ILineTypeMarkPointData* CreateData() = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int AddData(ILineTypeMarkPointData* pData) = 0;
