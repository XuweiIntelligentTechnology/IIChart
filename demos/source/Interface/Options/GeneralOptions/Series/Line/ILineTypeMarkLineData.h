#pragma once
/***********************************************************************
 * Module:  ILineTypeMarkLineData.h
 * Author:  杨鹏辉
...
#include "Options/GeneralOptions/Series/Line/ILineTypeMarkLineDataEmphasis.h"
#include "Options/GeneralOptions/Series/Line/ILineTypeMarkLineDataBlur.h"
...
namespace IIChart
{
	namespace Line
	{
		/*@class
		*************************************************************************
		* 类  名: ILineTypeMarkLineData
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 图表标线的起始点或终点的数据
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class ILineTypeMarkLineData : virtual public IBaseArrayElement
		{
		public:
			...
			******************************************************************
			功  能：该数据项高亮时的配置；
			参  数：<无>;
			返回值：<ILineTypeMarkLineDataEmphasis*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual ILineTypeMarkLineDataEmphasis* GetEmphasis() = 0;

			/*@function
			******************************************************************
			功  能：该数据项淡出时的配置；
			参  数：<无>;
			返回值：<ILineTypeMarkLineDataBlur*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual ILineTypeMarkLineDataBlur* GetBlur() = 0;
		};
	}
}