...
#include "Options/GeneralOptions/Series/Gauge/IGaugeTypeMarkLineBlur.h"
#include "Options/GeneralOptions/Series/Gauge/IGaugeTypeMarkLineEmphasis.h"
#include "Options/GeneralOptions/Series/Gauge/IGaugeTypeMarkLineData.h"
...
namespace IIChart
{
	namespace Gauge
	{
		/*@class
		*************************************************************************
		* 类  名: IGaugeTypeMarkLine
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 图表标线。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IGaugeTypeMarkLine
		{
		public:
			...
			*******************************************************************
			 ...
			 参  数：<wzHead>头部图片的 URL 或 dataURI也可以是 Path;
			         <wzTail>头部图片的 URL 或 dataURI也可以是 Path;
			 返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			...
			*******************************************************************
			 功  能：标线的高亮样式
			 参  数：<无>;
			 返回值：<IGaugeTypeMarkLineEmphasis*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IGaugeTypeMarkLineEmphasis* GetEmphasis() = 0;

			/*@function
			*******************************************************************
			 功  能：标线的淡出样式。淡出的规则跟随所在系列
			 参  数：<无>;
			 返回值：<IGaugeTypeMarkLineBlur*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IGaugeTypeMarkLineBlur* GetBlur() = 0;
			...
			******************************************************************
			功  能：创建标线的数据对象
			参  数：<无>;
			返回值：<IGaugeTypeMarkLineData*>;
			 ------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IGaugeTypeMarkLineData* CreateData() = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int AddData(IGaugeTypeMarkLineData* pData) = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int AddData(IGaugeTypeMarkLineData* pData0, IGaugeTypeMarkLineData* pData1) = 0;
