 ...
 *     同样的，这时候可以通过使用 valueIndex 指定维度。例：
...
namespace IIChart
{
	namespace Map
	{
		/*@class
		*************************************************************************
		* 类  名: IMapTypeMarkLineData
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 图表标线数据
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IMapTypeMarkLineData : virtual public IBaseArrayElement
		{
		public:
			...
			******************************************************************/
			...
			/*@function
			******************************************************************
			功  能：标记图形的大小，可以设置成诸如 10 这样单一的数字
			参  数：<nValue>;
			返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			...
			******************************************************************
			功  能：数据项的高亮样式
			参  数：<nValue>;
			返回值：<IMapTypeMarkLineEmphasisEx*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
