...
#include "Options/GeneralOptions/Series/Map/IMapTypeMarkLineData.h"
...
namespace IIChart
{
	namespace Map
	{
		/*@class
		*************************************************************************
		* 类  名: IMapTypeMarkLine
		* 修  改: 2022年7月1日 15:02:44
		* 功  能: 图表标线。
		-----------------------------------------------------------------------
		作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class IMapTypeMarkLine
		{
		public:
			/*@function
			******************************************************************
			...
			******************************************************************/
			...
			/*@function
			******************************************************************
			功  能：标线标记的大小，可以设置成诸如 10 这样单一的数字
			参  数：<eHead>;
				   <eTail>;
			返回值：<无>;
			 ------------------------------------------------------------------
			...
			******************************************************************
			功  能：创建标线的数据对象
			参  数：<无>;
			返回值：<IMapTypeMarkLineData*>;
			 ------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IMapTypeMarkLineData* CreateData() = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int AddData(IMapTypeMarkLineData* pData) = 0;
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual int AddData(IMapTypeMarkLineData* pData0, IMapTypeMarkLineData* pData1) = 0;
