...
#include "Options/GeneralOptions/Grid/IGridTooltipAxisPointer.h"
#include "Options/GeneralOptions/Grid/IGridTooltipTextStyle.h"
		...
		************************************************************************/
		...
		public:
			...
			******************************************************************
			...
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IGridTooltipAxisPointer* GetAxisPointer() = 0;
			...
			******************************************************************
			功  能：提示框浮层的文本样式;
			参  数：<无>;
			返回值：<IGridTooltipTextStyle*>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			virtual IGridTooltipTextStyle* GetTextStyle() = 0;
