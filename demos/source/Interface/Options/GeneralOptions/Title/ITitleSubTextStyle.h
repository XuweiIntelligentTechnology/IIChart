...
namespace IIChart
{
	...
	namespace Title
	{
		/*@class
		***********************************************************************
		 * 类  名: ITitleSubTextStyle
		 * 修  改: 2022年7月1日 15:02:44
		 * 功  能: 副标题样式;
		 -----------------------------------------------------------------------
		 * 作  者:  YangPenghui 2022-10-26;
		************************************************************************/
		class ITitleSubTextStyle
		{
		public:
			/*@function
			******************************************************************
			...
			******************************************************************
			功  能：文字水平对齐方式，默认自动;
			参  数：<nValue> 如果 IRich 中如果没有设置 align，则会取父层级的 align;
			返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
			...
			******************************************************************
			功  能：文字垂直对齐方式，默认自动;
			参  数：<nValue> 如果 IRich 中如果没有设置 VerticalAlign，则会取父层级的 VerticalAlign;
			返回值：<无>;
			------------------------------------------------------------------
			作  者:  YangPenghui 2022-10-26;
			******************************************************************/
