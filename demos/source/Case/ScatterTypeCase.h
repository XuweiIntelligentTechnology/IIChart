...
**************************************************************/
class CScatterTypeCase : public ICase
{
public:
	CScatterTypeCase(IIChart::IChartManager* pManager, CIIChartDemoDlg* pDlg, IChartEventDelegate* pDelegate);
	~CScatterTypeCase();
...
private:
	BOOL CreateBasicScatter();
	BOOL CreateClusteringProcess();
	BOOL CreatePunchCardofGithub();
