...
**************************************************************/
class CSunburstTypeCase : public ICase
{
public:
	CSunburstTypeCase(IIChart::IChartManager* pManager , CIIChartDemoDlg* pDlg, IChartEventDelegate* pDelegate);
	~CSunburstTypeCase();
...
private:
	...
	BOOL UpdateData();
	BOOL CreateSunburstTypeChart();
	BOOL CreateDrinkFlavors();

private:
	void RetrieveDrinkFlavorsData(Sunburst::ISunburstType*& pType);
