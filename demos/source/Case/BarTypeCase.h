...
**************************************************************/
class CBarTypeCase : public ICase
{
public:
	CBarTypeCase(IIChart::IChartManager* pManager, CIIChartDemoDlg* pDlg, IChartEventDelegate* pDelegate);
	~CBarTypeCase();
...
private:
	...
	BOOL CreateBasicBarChartInXY();
	BOOL CreateBasicBarChartInPolarRadiusAxis();
	BOOL CreateBasicBarChartInPolarAngleAxis();

	BOOL CreateX2YBasicBarChart();

	BOOL CreateMultiBarChart();
	BOOL CreateStackedBarChart();
